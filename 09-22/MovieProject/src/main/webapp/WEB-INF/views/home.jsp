	                	...
	                	<c:forEach items="${rankMovList}" var="rank" varStatus="status">	                
	                        <div class="col-lg-4 col-md-6">
	                            ...
	                            <div class="card mb-4">
	                                ...
	                                <div class="card-body">
	                                    <div class="small text-muted">예매율 : ${rank.recount }%</div>                                 
	                                    ...
	                                    <a class="btn btn-danger" href="${pageContext.request.contextPath }/reserveMovie?mvcode=${rank.mvcode}">예매하기</a>
	                                </div>
	                            </div>                           
	                        </div>                   
	                    </c:forEach>
		                    ...
		                    <div class="card mb-4">
		                        ...
		                        <c:choose>                       	
		                        	<c:when test="${sessionScope.loginState == 'YK' }">
		                        		 <div class="input-group">
			                        		 <img style="width: 30px; border-radius: 50%; object-fit: cover; height: 30px; margin-right: 15px;" alt="" src="${sessionScope.loginImg }">                                                           
			                            	 <p style="font-size: 20px; color: black;">${sessionScope.loginName}</p>
		                        		 </div>  
		                        	</c:when>
		                        	<c:otherwise>
		                        		 <div class="input-group">  
		                        		 <c:choose>
		                        		 	<c:when test="${sessionScope.loginImg == null }">
		                        		 		<img style="width: 30px; border-radius: 50%; object-fit: cover; height: 30px; margin-right: 15px;" alt="" src="${pageContext.request.contextPath }/resources/user/memUpload/기본이미지.png">
		                        		 	</c:when>
		                        		 	<c:otherwise>
				                        		<img style="width: 30px; border-radius: 50%; object-fit: cover; height: 30px; margin-right: 15px;" alt="" src="${pageContext.request.contextPath }/resources/user/memUpload/${sessionScope.loginImg}">                                                            
		                        		 	</c:otherwise>
		                        		 </c:choose>
		                            	<p style="font-size: 20px;">${sessionScope.loginName}</p>
		                            </div>
		                        	</c:otherwise>
		                        </c:choose>
		                        </div>
	                            ...
	                            <div class="row">
	                                <div class="col-sm-6">
	                                    <ul class="list-unstyled mb-0">
	                                        <li><a href="${pageContext.request.contextPath }/reserveInfo">예매내역</a></li>
	                                        <li><a href="#!">HTML</a></li>
	                                ...
	                                <div class="col-sm-6">
	                                    <ul class="list-unstyled mb-0">
	                                        <li><a href="${pageContext.request.contextPath }/memberInfo">회원정보</a></li>
